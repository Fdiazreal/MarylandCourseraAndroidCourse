...
public class ToDoListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		boolean isStatusDone = toDoItem.getStatus() == Status.DONE;
		Log.i("FedeLog", "Stateus is done: " + isStatusDone);
		statusView.setActivated(isStatusDone);
		...
		Priority priority = toDoItem.getPriority();
		switch (priority) {
		case LOW:
